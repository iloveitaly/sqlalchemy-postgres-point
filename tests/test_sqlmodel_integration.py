...
from tests.helpers.db import database_available, get_engine
from tests.helpers.models import Place
...
def test_distance_operator_compiles(engine):
    ...
    stmt = select(Place.__table__.c.location.earth_distance((3.0, 4.0)))
